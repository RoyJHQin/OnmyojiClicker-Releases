...
从 [GameVisionLab 1.0.2](https://github.com/RoyJHQin/OnmyojiClicker-Releases/releases/tag/gamevisionlab-v1.0.2) 下载：
...
- 新增“通用战斗”玩法，适用于绝大部分“固定入口 → 重复战斗 → 结算后再次进入”的玩法形式。
- 新增“英杰试炼－秘境”玩法，覆盖梦墟秘境、兵藏秘境、战斗结算和祝福选择；战斗结束后可自动选择左侧第一个祝福。
- 优化配置中心的界面、点击动作和流程管理体验，并修复删除界面后可能残留无效动作引用的问题。
- 首次安装自动载入本版本内置配置：22 个界面、18 个点击动作、7 套流程和 40 个流程节点。
- 新增 GitHub Release 更新提示，每天最多检查一次；只提示下载，不会自动替换 App。
